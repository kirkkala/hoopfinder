 ...
 *
 * compact (< wide): add-court after the beta badge, hamburger; info/language/admin/sign-in in the menu
 * wide: info then add-court then admin after the beta badge; inline lang; hamburger; info/language/admin/sign-in also in the menu
